...
expName = 'Trail1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='F:\\Thesis\\PupilAssistedSpellCorrectionForGazeTyping\\Research\\ORGINAL_lastrun.py',
...
# keep track of which components have finished
GoodBye_ScreenComponents = [text_2, key_Goodbye]
...
while continueRoutine:
    ...
    if key_Goodbye.status == STARTED and not waitOnFlip:
        theseKeys = key_Goodbye.getKeys(keyList=None, waitRelease=False)
